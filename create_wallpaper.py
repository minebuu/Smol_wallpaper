...
nft_url = {'smol_male': "https://minebuu.mypinata.cloud/ipfs/QmY71ban6QoWg9nbNwikk6wVWknj8NFBG8nMGHEuzwfAwf/", 'smol_female': "https://minebuu.mypinata.cloud/ipfs/QmR87K1oY8dXL4op91A9zcz4hPmCd8JbMVDTTuUnpXyQcr/", 'brain_pet': "https://minebuu.mypinata.cloud/ipfs/QmdRyjjv6suTcS9E1aNnKRhvL2McYynrzLbg5VwXH8cCQB/"}
...
def save_nft_image(nft_name, id, head_size):
	...
	if nft_name == "smol":
		...
		if os.path.exists("./images/smol/" + file_name):
			print(file_name + " is already exist")
		else:
			opener = urllib.request.build_opener()
			opener.addheaders = [('User-agent', 'Mozilla/5.0')]
			urllib.request.install_opener(opener)
			urllib.request.urlretrieve(url, "./images/smol/"  + file_name)

	elif nft_name == "brain_pet":
		file_name = nft_name + "_" + str(id) + ".png"
		file_gif = nft_name + "_" + str(id) + ".gif"
		if os.path.exists("./images/brainPets/" + file_name):
			print(file_name + " is already exist")
		else:
			opener = urllib.request.build_opener()
			opener.addheaders = [('User-agent', 'Mozilla/5.0')]
			urllib.request.install_opener(opener)
			urllib.request.urlretrieve(url, "./images/brainPets/"  + file_gif)
			img = Image.open("./images/brainPets/" + file_gif)
			img.save("./images/brainPets/" + file_name,'png', optimize=True, quality=100)
	return file_name
...
for id in range(LAST_FEMALE):
	for size in range(5):
		# save_nft_image("smol",id, size)
